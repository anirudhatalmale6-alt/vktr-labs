<footer class="site-footer">
    <div class="container">
        <div class="footer-grid">
            ...
            <div class="footer-col">
                ...
                <ul>
                    ...
                    <li><a href="<?php echo esc_url(home_url('/terms/')); ?>">Terms &amp; Disclaimer</a></li>
                </ul>
            </div>
            <div class="footer-col">
                <h4>Shipping</h4>
        ...
        <div class="footer-bottom">
            ...
            <span>All products are sold strictly for research purposes only.</span>
        </div>
    </div>
</footer>

<?php
$whatsapp_number = get_option('vktr_whatsapp_number', '');
if ($whatsapp_number):
?>
<a href="https://wa.me/<?php echo esc_attr(preg_replace('/[^0-9]/', '', $whatsapp_number)); ?>" class="whatsapp-float" target="_blank" rel="noopener" title="Chat with us on WhatsApp">
